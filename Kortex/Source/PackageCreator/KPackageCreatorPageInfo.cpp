...
namespace Kortex::PackageDesigner
{
	...
	void KPackageCreatorPageInfo::CreateBasicInfoControls()
	{
		...
		{
			KPCInfoAdditionalInfoModelDialog dialog(this, KTr("PackageCreator.PageInfo.BasicInfo.UserData"), m_Controller, true);
		...
		{
			KPCInfoDocumentsModelDialog dialog(this, KTr("PackageCreator.PageInfo.BasicInfo.Documents"), m_Controller);
